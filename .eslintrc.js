module.exports = {
  ...
  rules: {
    ...
    'prettier.jsxBracketSameLine': 'off', // 在jsx中把'>' 是否单独放一行
    ...
    'comma-style': [0, 'last'], // 控制逗号在行尾出现还是在行首出现
    ...
    'no-case-declarations': 0, //不可在switch case中定义变量
    ...
    'max-lines': [1, 1000], //文件最大行数不能超过1000
    'max-nested-callbacks': [1, 4], //回调函数最大嵌套深度 4 层
